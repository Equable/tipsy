...
class NewReviewTile extends Component {
  constructor(props) {
    super(props);
    this.state = {
      rating: 3,
  ...
  componentDidMount(){
    this.setState({cocktail_id: this.props.cocktailId})
  }
    ...
    return (
      <div className="new-review-tile">
        <div className="grid-x align-center grid-margin-y">
          <div className="cell medium-8 cocktail-show-tile">
